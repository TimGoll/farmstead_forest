...
recipes.addShaped(<waterstrainer:strainer_base>, [[<ore:logSplit>, null, <ore:logSplit>], [<ore:plankWood>, <harvestcraft:watertrap>, <ore:plankWood>], [<ore:cobblestone>, <ore:cobblestone>, <ore:cobblestone>]]);
